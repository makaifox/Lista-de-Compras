...
//cria a tabela e preenche com os valores da lista acima
...
function validation() {
    ...
    if (amount === "") {
        ...
        errors += '<p>Fill out. a valid number</p>';
    }
    if (value === "") {
...
//inicializar lista ao abrir pagina
